        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={item} className="space-y-6 text-muted-foreground text-lg leading-relaxed">
              <p>
                Hi! I'm Sahiti Veeravalli — a full-stack developer who loves turning complex problems
                into elegant, user-friendly solutions. I thrive at the intersection of design and engineering.
              </p>
              <p>
