    ...
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        ...
        <motion.a
          ...
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ delay: 0.7 }} href="mailto:sahithi.veeravalli19@gmail.com">
          
          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
   hi.veeravalli19@gmailhiti@example.com
        </motion.a>
        ...
        <motion.div
          ...
          {[
          { label: "GitHub", href: "https://github.com/sahiti-veeravallittps://github.com/sahiti-veeravalli", icon:
