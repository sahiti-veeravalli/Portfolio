  ...
  return (
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          <p className="text-primary font-mono text-sm tracking-[0.3em] uppercase mb-4">Get in Touch</p>
          <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold mb-8">
            Let's create<br />
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-3 px-10 py-5 bg-primary text-primary-foreground rounded-full text-xl font-bold hover:opacity-90 transition-all glow-primary"
